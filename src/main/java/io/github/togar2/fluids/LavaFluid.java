...
public class LavaFluid extends FlowableFluid {
    ...
    private boolean isUltrawarm(Instance instance) {
        return DimensionType.THE_NETHER.equals(instance.getDimensionType());
    }

    @Override
    protected int getLevelDecreasePerBlock(Instance instance) {
        return isUltrawarm(instance) ? 1 : 2;
    }

    @Override
    protected int getHoleRadius(Instance instance) {
        return isUltrawarm(instance) ? 4 : 2;
    }
    ...
    public int getNextTickDelay(Instance instance, BlockVec point) {
        return isUltrawarm(instance) ? 10 : 30;
    }
